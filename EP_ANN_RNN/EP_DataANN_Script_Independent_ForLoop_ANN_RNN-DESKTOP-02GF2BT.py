...
for kk in range(Total_Aggregation_Zone_Number):
    ...
    if (FeatureType == 0):
        ...
        if (ANN_Type == 1):
            ...
            Train_X = pd.concat(
                ...
                AggregatedTrain_DF[['Site_Outdoor_Air_Drybulb_Temperature_', 'Zone_Air_Temperature_']].iloc[:-1, :]],
                axis=1)
            Train_Y = AggregatedTrain_DF['Zone_Air_Temperature_'].iloc[Lag_Length:]
            ...
            Test_X = pd.concat(
                ...
                AggregatedTest_DF[['Site_Outdoor_Air_Drybulb_Temperature_', 'Zone_Air_Temperature_']].iloc[:-1, :]],
                axis=1)
            Test_Y = AggregatedTest_DF['Zone_Air_Temperature_'].iloc[Lag_Length:]
    ...
    # Crerating File Name
    TrainVal_LossError_File_Name = ANNModel_Key + '_TrainVal_LossError_DF' + '_Ind_' + str(Total_Aggregation_Zone_Number) + 'Zone_' + str(kk) + '.pickle'
    ...
    Predict_Actual_Y_DF_File_Name1 = ANNModel_Key + '_Predict_Actual_Y_DF' + '_Ind_' + str(Total_Aggregation_Zone_Number) + 'Zone_' + str(kk) + '.pickle'
...
PHVAC1_Accuracy_File_Name = ANNModel_Key + '_PHVAC_Model_Accuracy_withoutSim'+ '_Ind_' + str(Total_Aggregation_Zone_Number) + 'Zone' + '.csv'
...
# Saving the Accuracy Table as a .csv File in Results Folder
PHVAC_Accuracy_File_Name = ANNModel_Key + '_PHVAC_Model_Accuracy_withSim'+ '_Ind_' + str(Total_Aggregation_Zone_Number) + 'Zone' + '.csv'
