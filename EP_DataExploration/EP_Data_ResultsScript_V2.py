...
for ii in range(len(Y_Axis_Data_Columns)):
    ...
    if (ii < 5):
        ...
        plt.plot(X_Axis_Data, Y_Axis_Data[Y_Axis_Data_Columns[ii]], linestyle='dashed', marker=Plot_Marker_Type[ii], markevery=Marker_Gap, fillstyle = 'none')
...
plt.ylabel('Zone Air Temperature', fontsize=Axis_FontSize)
