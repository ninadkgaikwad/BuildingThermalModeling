...
for kk in range(Total_Aggregation_Zone_Number):
    ...
    for ii in range(ANN_HeatInput_Train_DF.shape[0]):
        ...
        QAC_Train_1 = AggregatedTrain_DF['QHVAC_X'][ii][0] # Changes
    ...
    for ii in range(ANN_HeatInput_Test_DF.shape[0]):
        ...
        QAC_Test_1 = AggregatedTest_DF['QHVAC_X'][ii][0] # Changes
    ...
    Train_Y_Predict = Current_ANNModel.predict(Train_X1)
