...
Total_Aggregation_Zone_Number = 3

Aggregation_Unit_Number = 3
...
Predicted_Temperature_withSim_Dep2 = Predict_Actual_Y_DF_withSim_Dep2.iloc[:,7]
...
Y_Axis_Data.rename(columns = {'Actual_Y':'Actual Temp.', 'Predict_Y_BiasNotAccounted': 'Predicted Temp. Independent', 'Predict_Y_NoBias2': 'Predicted Temp. Dependent'},inplace = True)
