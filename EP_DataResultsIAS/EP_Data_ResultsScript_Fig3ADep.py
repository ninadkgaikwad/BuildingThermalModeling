...
Sim_ANNModelData_Case_Folder_Name = 'Dep1_2Z_100EP_25B_100REG_Bias'
...
Predict_Actual_Y_DF_withoutSim_File = open(os.path.join(Sim_ANNModelData_Case_FolderPath, 'Predict_Actual_Y_DF_2Zone_withoutSim.pickle'),
                                    "rb")

Predict_Actual_Y_DF_withoutSim = pickle.load(Predict_Actual_Y_DF_withoutSim_File)

# Getting Predict_Actual_Y_DF_withSim_File
Predict_Actual_Y_DF_withSim_File = open(os.path.join(Sim_ANNModelData_Case_FolderPath, 'Predict_Actual_Y_DF_2Zone_withSim.pickle'),
                                    "rb")
...
# Saving Plot
Plot_Name = 'PredictedActualTemperature_TimeSeriesPlot_' + str(Total_Aggregation_Zone_Number) + 'Zone' + '_TestJulyDep1' + '.png'
