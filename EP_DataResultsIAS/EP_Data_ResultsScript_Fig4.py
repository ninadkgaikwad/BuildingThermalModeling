...
# Predicted_PHVAC_withSim_Dep1_Plot = Predict_Actual_Y_DF_withSim_Dep1.iloc[0:2015]
...
# Y_Axis_Data.rename(columns = {'Actual_Y':'Actual', 'Predict_Y_BiasNotAccounted': 'Predicted'},inplace = True)
