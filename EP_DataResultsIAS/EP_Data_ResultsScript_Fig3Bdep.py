...
Predicted_Temperature_withSim_Dep1 = Predict_Actual_Y_DF_withSim_Dep1.iloc[:,5]
Predicted_Temperature_withSim_Dep1 = Predicted_Temperature_withSim_Dep1.dropna()
Predicted_Temperature_withSim_Dep1.reset_index(drop=True, inplace=True)
Predicted_Temperature_withSim_Dep1_Plot = Predicted_Temperature_withSim_Dep1.iloc[0:2015]
...
Y_Axis_Data_List = [Actual_Temperature_Plot, Predicted_Temperature_withSim_Ind_Plot, Predicted_Temperature_withSim_Dep1_Plot]
Y_Axis_Data = pd.concat(Y_Axis_Data_List, axis = 1)
Y_Axis_Data.rename(columns = {'Actual_Y':'Actual Temp.', 'Predict_Y_BiasNotAccounted': 'Predicted Temp. Independent', 'Predict_Y_NoBias2': 'Predicted Temp. Dependent 1'},inplace = True)
